...
parser.parse(read('WorkoutFeature.jsx'), { sourceType: 'script', plugins: ['jsx'] });
parser.parse(read('exercise-dataset-service.js'), { sourceType: 'script' });
...
if (!index.includes('./exercise-dataset-service.js')) throw new Error('index.html no carga exercise-dataset-service.js');
if (!index.includes('./WorkoutFeature.jsx')) throw new Error('index.html no carga WorkoutFeature.jsx');
